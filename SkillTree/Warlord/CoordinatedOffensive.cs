...
{
    public class CoordinatedOffensive : Skill
    {
        public CoordinatedOffensive(int level)
        {
            Level = level;
        }

        public string Name => "CoordinatedOffensive";
        public string FriendlyName => "Coordinated Offensive";
        public int Tier => 3;
