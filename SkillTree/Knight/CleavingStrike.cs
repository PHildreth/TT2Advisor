...
namespace TT2Advisor.SkillTree.Knight
{
    public class CleavingStrike : ISkill
    {
        ...
        public string Name => "CleavingStrike";
        public string FriendlyName => "Cleaving Strike";
        public int Tier => 3;
        ...
        public DamageTypeEnum DamageType => DamageTypeEnum.MaximumCriticalDamage;

        public double MaximumCriticalDamage => Level switch
        {
            0 => 0,
            1 => 1.2,
            2 => 1.71,
