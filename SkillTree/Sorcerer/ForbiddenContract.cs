...
{
    public class ForbiddenContract : Skill
    {
        public ForbiddenContract(int level)
        {
            Level = level;
        }

        public string Name => "ForbiddenContract";
        public string FriendlyName => "Forbidden Contract";
        public int Tier => 2;
